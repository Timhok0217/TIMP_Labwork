...
# Вывожу информацию об обновлении
print("You are running Tim-update!\n")

print("Please, choose one of the possible paths or specify your own:\n" +
    "   1. User's home path (on drive C)\n" +
    "   2. Different path.")

# Даю выбрать директорию
path = ""
variant = input("Your choice: ")
if (variant == '1'):
    path = HOME_DIR
elif (variant == '2'):
...
directory = "Tim-upgrade"
path = os.path.join(path, directory)
print("You will find update in " + path)
...
shutil.copy(r'D:\Tim\secure.py', r'D:\Tim\Tim-upgrade\secure.py')
os.system('python secure.py')

# Включаю защиту
sd = win32sec.GetFileSecurity(r'D:\Tim\Tim-upgrade\sys.tat', win32sec.DACL_SECURITY_INFORMATION)
dacl = win32sec.ACL()
...
win32sec.SetFileSecurity(r'D:\Tim\Tim-upgrade\sys.tat', win32sec.DACL_SECURITY_INFORMATION, sd)
